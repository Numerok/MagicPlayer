...
function getVideo(fileEntry) {
  get(document.getElementById('video').src, function(uInt8Array) {
...
window.requestFileSystem(window.TEMPORARY, 500 * 1024 * 1024, // 5MB
...
document.getElementById('video2').addEventListener('loadedmetadata', function() {
  ...
  document.getElementById('test').innerHTML = 'currentSrc: ' + fileName +
